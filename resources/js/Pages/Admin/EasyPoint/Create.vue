...
const submit = () => {
    form.post(route('admin.easypoint.store'));
};
</script>

<template>
    <AdminLayout>
        <Head title="เพิ่มโพสต์ Easy Point" />
        <div class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-slate-200">
            <h2 class="text-2xl font-bold text-slate-800 mb-6"><i class="bi bi-coin text-yellow-500"></i> เพิ่มโพสต์ Easy Point</h2>
